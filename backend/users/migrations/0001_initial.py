    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, max_length=254, unique=True, validators=[django.core.validators.RegexValidator(message='Введены недопустимый символ', regex='^[\\w.@+-]+$')], verbose_name='Логин')),
